...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar flex justify-between items-center pt-[50px] pb-[30px] px-[78px]">
        <div className="navbar-start align-items-center">
          <div className="flex items-center gap-[25px]">
            <Link href="https://solana.com" className="mr-4">
              Home
            </Link>
            <Link href="https://solana.com" className="mr-4">
              About
        ...
        <div className="navbar-end">
          <div className="md:inline-flex align-items-center justify-items gap-6">
            ...
            <WalletMultiButtonDynamic className="btn-ghost btn-sm rounded-btn text-lg mr-6">
              {wallet.connected ? null : <><img src="/img/nav-wallet.svg" alt="wallet" />Select Wallet</>}
